...
export class Tabs {
    ...
    getForecastData(city) {
     ...
     базированная гигачад функция возвращает массив с объектами данных для каждой коробочки в 3 табе.
     подробнее:
     1.  обработка промиса getLatLonUrl, который возвращает ссылку для запроса fetch с нужными элементами - lat и
         lon (координаты для запроса на 3 табе), происходит fetch запрос, который возвращает огромный объект с прогнозом
